...
keep stealing the keys back until they catch you.
...
**Every round after — Steal.** The house resets, the keys hide somewhere **new**, and one
...
**Couch mode** (toggle with **T** on the results screen): two players, one keyboard,
alternating rounds — your routes and your opponent's both haunt whoever's up (cool tints
for P1's ghosts, warm for P2's). First player caught out loses; the rematch swaps who
gets the threat-free search round.
